    ...
    <main>
      ...
      <section className="relative isolate min-h-[calc(100vh-40px)] overflow-hidden px-3 pb-12 pt-6 sm:min-h-[calc(100vh-72px)] sm:px-6 sm:pt-5">
        ...
        <div className="relative z-10">
          <h1 className="mx-auto w-[68%] max-w-[320px] text-center font-montserrat text-[17px] font-bold leading-[1.35] text-gold sm:mt-[68px] sm:w-auto sm:max-w-[560px] sm:text-[28px] sm:leading-[1.1]">
